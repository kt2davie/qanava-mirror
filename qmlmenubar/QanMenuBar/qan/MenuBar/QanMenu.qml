...
Rectangle {
    ...
    y: parent.height / 5
    width: 70
    height: ( elementCount * 70 + separatorCount * 10 > 80 ? elementCount * 70 + separatorCount * 10 : 80);
    //height: 180
    ...
    property real   menuHeight: ( elementCount * 70 + separatorCount * 10 > 80 ? elementCount * 70 + separatorCount * 10 : 80)
